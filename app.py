...
y muestra un mensaje con la contraseña cuando se encuentra (educativo).
No guarda la contraseña en el servidor ni en logs.
"""
...
# Texto descriptivo sobre rockyou (tal como pediste)
ROCKYOU_DESC = (
